...
func _enter_tree():
	...
	add_custom_type("ProtoGizmoWrapper", "Node", preload("proto_gizmo_wrapper/proto_gizmo_wrapper.gd"), preload("res://addons/proto_shape/icon/proto-gizmo-wrapper-icon.png"))
